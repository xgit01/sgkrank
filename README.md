...
**整理来自互联网的2025年最新免费好用的在线社工库查询网站(https://www.shegongku.top) 和Telegram电报社工库机器人，这些免费开盒社工库功能各异，大概都是可以查询泄漏的各平台帐号、密码、查Q绑定、查邮箱/手机号机主/户籍、查身份证以及各种隐私数据是否泄露，看看你是否也处于数据外泄事件之中。**
...
老牌Telegram社工库机器人暗精灵社工库是一个支持简单查询、人工查档、猎魔、人肉搜索的综合社工库查询工具。此社工库社工库收录全网最全快递及订单数据（来自淘宝、京东等购物网站的4541420022条泄露数据），绝对的老牌社工库，可查手机、QQ、微博、快递、身份户籍，目前已关闭签到功能，只能通过分享或充值获取积分。
